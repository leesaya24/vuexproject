  ...
  <v-app id="inspire">
    ...
    >
      <v-list dense>
        ...
        <v-list-tile router :to="{name : 'user'}">
          <v-list-tile-content>
            <v-list-tile-title>유저정보</v-list-tile-title>
          </v-list-tile-content>
        </v-list-tile>
        <v-list-tile router :to="{name : 'resource'}">
          <v-list-tile-content>
            <v-list-tile-title>리소스 정보</v-list-tile-title>
          </v-list-tile-content>
        </v-list-tile>
        <v-list-tile router :to="{name : 'sum'}">
          <v-list-tile-content>
